...
svn copy -m 'creating branch A' file:///tmp/hello/trunk \
         file:///tmp/hello/branches/productA-1.0

# work on some product B that has common libraries.
svn copy -m 'creating branch B' file:///tmp/hello/trunk \
         file:///tmp/hello/branches/productB-1.0

# while we are at it, start a beta that combines both products.
svn copy -m 'creating branch combined' file:///tmp/hello/trunk \
         file:///tmp/hello/branches/combinedBeta

cd ..
svn checkout file:///tmp/hello/trunk project
